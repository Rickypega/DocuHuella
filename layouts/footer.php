        ...
        <div class="container text-center">
            <div class="row">
                <div class="col-md-12 mb-3">
                    ...
                    <a href="views/privacidad.php" class="text-white text-decoration-none mx-2">Política de Privacidad</a>
                    <span class="opacity-50">|</span>
                    <a href="views/terminos.php" class="text-white text-decoration-none mx-2">Términos de Uso</a>
                </div>
            </div>
