...
<head>
    ...
    <style>
        ...
        #formCrear .form-select {
            border: 1px solid #dee2e6 !important;
        }

        #formGestionar .form-control,
        #formGestionar .form-select {
            border: 1px solid #dee2e6 !important;
        }

        #formGestionar .border-danger {
...
<body>
    ...
    <div class="offcanvas-md offcanvas-start sidebar" tabindex="-1" id="sidebarMenu">
        ...
        <nav class="mt-3">
            ...
            <a href="<?= URL_BASE ?>/views/admin/clinicas.php" class="active"><i class="fas fa-hospital"></i> Mis
                Sucursales</a>
    ...
    <div class="main-content">
        ...
        <div class="mb-4 pb-2 border-bottom d-flex justify-content-between align-items-center flex-wrap gap-3">
            ...
            <button class="btn text-white" style="background-color:var(--dh-navy);" data-bs-toggle="modal"
                            ...
                            <tr>
                                ...
                                <td class="text-center">
                                    <button class="btn btn-sm btn-outline-primary btn-gestionar"
                                        ...
                                        data-estado="<?= $s['Estado'] ?>" data-bs-toggle="modal"
                    ...
                    <div class="modal-body p-4">
                        <div class="row g-3">
                            ...
                            <div class="col-md-6">
                                ...
                                <input type="text" name="nombre_sucursal" id="c_nombre" class="form-control"
                            ...
                            <div class="col-md-6">
                                ...
                                <input type="text" name="telefono" id="c_telefono"
                                    class="form-control mascara-tel-clinica" maxlength="12" placeholder="809-000-0000"
                                    inputmode="numeric" required>
                                <small id="msg_tel_crear" class="text-danger d-none fw-bold"
                            ...
                            <div class="col-md-6">
                                ...
                                <input type="text" name="rnc" id="c_rnc" class="form-control mascara-rnc-clinica"
                                    maxlength="11" placeholder="000-00000-0" inputmode="numeric" required>
                                <small id="msg_rnc_crear" class="text-danger d-none fw-bold"
                                    style="font-size:0.75rem;">RNC incompleto (9 dígitos)</small>
                            </div>
                        ...
                        <div class="row g-3">
                            ...
                            <div class="col-md-6">
                                ...
                                <input type="text" name="telefono" id="g_telefono"
                                    class="form-control mascara-tel-clinica" maxlength="12" placeholder="809-000-0000"
                                    required>
                                <small id="msg_tel_gest" class="text-danger d-none fw-bold"
                                    style="font-size:0.75rem;">Teléfono incompleto</small>
                            </div>
                            ...
                            <div class="col-md-6">
                                ...
                                <input type="text" name="rnc" id="g_rnc" class="form-control mascara-rnc-clinica"
                                    maxlength="11" required>
                                <small id="msg_rnc_gest" class="text-danger d-none fw-bold"
                                    style="font-size:0.75rem;">RNC incompleto</small>
                            </div>
                                ...
                                <div class="mt-1 p-3 rounded"
                                    ...
                                    <div class="d-flex justify-content-between align-items-center">
                                        <div>
                                            ...
                                            <small class="text-muted">Suspender desactiva el acceso de los veterinarios
                                                de esta sucursal.</small>
                                        </div>
                                        <button type="button" id="btn_toggle_estado"
                                            class="btn btn-warning text-dark fw-bold" onclick="toggleEstadoClinica()">
