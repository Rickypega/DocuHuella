...
<header class="hero text-center" id="hero-animated">
    <div class="container hero-content">
        ...
        <div class="d-flex flex-wrap justify-content-center gap-3">
            <a href="<?= URL_BASE ?>/registro" class="btn-dh btn-lg">Comenzar Ahora</a>
            <div class="d-flex align-items-center">
                <i class="fas fa-paw fs-3" style="color: var(--dh-navy);"></i>
            </div>
            <a href="<?= URL_BASE ?>/login" class="btn-dh btn-lg">Iniciar Sesión</a>
        </div>
    </div>
</header>
        ...
        <div class="row g-4">
            <div class="col-md-4">
                <div class="card h-100 p-4 benefit-card text-center">
                    ...
                    <p class="text-muted">Ten el historial clínico de tu mejor amigo siempre a mano. Mantén el control
                        total de sus vacunas y tratamientos.</p>
                </div>
            </div>
            <div class="col-md-4">
                <div class="card h-100 p-4 benefit-card text-center">
                    ...
                    <p class="text-muted">Optimiza tus consultas con expedientes digitales rápidos. Olvídate del papel y
                        accede a la información clínica desde cualquier dispositivo.</p>
                </div>
            </div>
            <div class="col-md-4">
                <div class="card h-100 p-4 benefit-card text-center">
                    ...
                    <p class="text-muted">Gestión de inventarios y estadísticas. Mejora la eficiencia de tu negocio con
                        datos precisos en tiempo real.</p>
                </div>
            </div>
        </div>
    </div>
    ...
    <div class="container text-center">
        <div class="row align-items-center">
            <div class="col-md-6 text-start">
                ...
                <p>En DocuHuella protegemos cada dato. Con nuestro sistema de seguridad, la información está blindada.
                </p>
